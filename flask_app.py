...
def handle_dialog(req, res):
    ...
    # if req['request']['nlu']['tokens'].lower() in [
    #    'ладно',
    #    'куплю',
    #    'покупаю',
    #    'хорошо'
    # ]:
    if 'ладно' in req['request']['nlu']['tokens'] or 'куплю' in req['request']['nlu']['tokens'] or 'покупаю' in \
            req['request']['nlu']['tokens'] or 'хорошо' in req['request']['nlu']['tokens']:
        res['response']['text'] = f'{animal}а можно найти на Яндекс.Маркете!'
